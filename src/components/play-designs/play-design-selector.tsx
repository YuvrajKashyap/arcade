...
import type { PlayDesignCatalogEntry } from "@/lib/play-designs/catalog";

type Props = {
  designs: readonly PlayDesignCatalogEntry[];
};

export function PlayDesignSelector({ designs }: Props) {
  return (
      ...
      <div className="relative mx-auto flex min-h-screen max-w-3xl flex-col justify-center px-6 py-20 sm:px-8">
        ...
        >
          ...
          <p className="mt-4 text-sm text-white/30">
            5 game page directions &mdash; pick one to preview
          </p>
        </motion.div>
