...
- [Product Showcase](./product-showcase.md): desktop and mobile evidence for every public-facing route and shared interaction state.
...
If you are re-entering the repo after some time away, start with:

1. [README.md](../README.md)
2. [Architecture](./architecture.md)
3. [Adding a Game](./adding-a-game.md)
